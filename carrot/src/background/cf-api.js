...
export class Api {
  ...
  async contestStatus(contestId, from = undefined, count = undefined) {
    return await this.fetch('contest.status', { contestId, from, count });
  }

  async contestHacks(contestId) {
    return await this.fetch('contest.hacks', { contestId });
  }
